...
__webpack_require__.d(reducers_namespaceObject, "reducer", function() { return gameReducer; });
...
// CONCATENATED MODULE: ./routes/home/news-tile.js


function news_tile__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function news_tile__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function news_tile__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var news_tile_NewsTile = function (_Component) {
  news_tile__inherits(NewsTile, _Component);

  function NewsTile() {
    news_tile__classCallCheck(this, NewsTile);

    return news_tile__possibleConstructorReturn(this, _Component.apply(this, arguments));
  }

  NewsTile.prototype.componentDidMount = function componentDidMount() {};

  NewsTile.prototype.render = function render(props) {
    return Object(preact_min["h"])(
      Card_default.a,
      { 'class': home_style_default.a.news },
      Object(preact_min["h"])(
        'a',
        { 'class': home_style_default.a.cardHeader, style: 'background-image:url(' + props.news.img + ')' },
        Object(preact_min["h"])(
          'div',
          { 'class': home_style_default.a["headline-shadow"] },
          Object(preact_min["h"])(
            'div',
            null,
            Object(preact_min["h"])(
              Typography_default.a,
              { headline6: true, 'class': home_style_default.a.headline },
              props.news.headline
            )
          ),
          Object(preact_min["h"])(
...
var home_Home = function (_Component) {
	...
	Home.prototype.render = function render(props) {
		return Object(preact_min["h"])(
			...
			props.reducer.news.map(function (news) {
				return Object(preact_min["h"])(news_tile_NewsTile, { news: news });
			})
		);
	};
...
function gameReducer() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { news: [] };
	var action = arguments[1];

	switch (action.type) {
		case NEWS_FETCHED:
			{
				return reducer__extends({}, state, action.data);
			}
		default:
			return state;
	}
...
var store_reducer = combineReducers(reducers_namespaceObject);
var logger = Object(redux_logger["createLogger"])({
  predicate: function predicate(getState, action) {
    return action.type !== false;
  }
});

var middlewares = [redux_thunk_es];

middlewares.push(logger);

var store = createStore(store_reducer, applyMiddleware.apply(undefined, middlewares));
...
// removed by extract-text-webpack-plugin
module.exports = {"home":"home__MseGd","cardHeader":"cardHeader__2Vd1U","headline-shadow":"headline-shadow__2WVTT","cardBody":"cardBody__fYYFu","news":"news__3W1hh"};
