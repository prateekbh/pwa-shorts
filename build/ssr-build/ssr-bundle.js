  ...
  for (var i = 0; i < reducerKeys.length; i++) {
    ...
    if (false) {
      if (typeof reducers[key] === 'undefined') {
        redux_warning('No reducer provided for key "' + key + '"');
      }
    }
...
var preact_redux_esm_invariant = function invariant() {};
...
selectorFactory) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    preact_redux_esm_invariant(typeof WrappedComponent == 'function', 'You must pass a component to the function returned by ' + ('connect. Instead received ' + JSON.stringify(WrappedComponent)));
    ...
    var Connect = function (_Component) {
      ...
      function Connect(props, context) {
        ...
        preact_redux_esm_invariant(_this.store, 'Could not find "' + storeKey + '" in either the context or props of ' + ('"' + displayName + '". Either wrap the root component in a <Provider>, ') + ('or explicitly pass "' + storeKey + '" as a prop to "' + displayName + '".'));
      ...
      Connect.prototype.getWrappedInstance = function getWrappedInstance() {
        preact_redux_esm_invariant(withRef, 'To access the wrapped instance, you need to specify ' + ('{ withRef: true } in the options argument of the ' + methodName + '() call.'));
...
var preact_redux_esm_root = freeGlobal || freeSelf || Function('return this')();

/** Built-in value references. */
var _Symbol = preact_redux_esm_root.Symbol;
...
// CONCATENATED MODULE: ../node_modules/@researchgate/react-intersection-observer/lib/es/utils.js


function isDOMTypeElement(element) {
    return preact_compat_es.isValidElement(element) && typeof element.type === 'string';
}
...
function createObserver(options) {
    return getPooled(options) || new IntersectionObserver(observer_callback, options);
}
...
function IntersectionObserver__classCallCheck(instance, Constructor) {
    if (!(instance instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
    }
}

function IntersectionObserver__possibleConstructorReturn(self, call) {
    if (!self) {
        throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
    }return call && (typeof call === "object" || typeof call === "function") ? call : self;
}

function IntersectionObserver__inherits(subClass, superClass) {
    if (typeof superClass !== "function" && superClass !== null) {
        throw new TypeError("Super expression must either be null or a function, not " + typeof superClass);
...
var IntersectionObserver_objectProto = Object.prototype;

var IntersectionObserver_IntersectionObserver = function (_React$Component) {
    IntersectionObserver__inherits(IntersectionObserver, _React$Component);

    function IntersectionObserver() {
        var _temp, _this, _ret;

        IntersectionObserver__classCallCheck(this, IntersectionObserver);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = IntersectionObserver__possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.handleChange = function (event) {
            ...
            if (typeof _this.props.children.ref === 'function') {
                _this.props.children.ref(target);
            }
            /**
        ...
        }, _temp), IntersectionObserver__possibleConstructorReturn(_this, _ret);
    }
    ...
    IntersectionObserver.prototype.render = function render() {
        ...
        return preact_compat_es.cloneElement(preact_compat_es.Children.only(this.props.children), {
            ref: this.handleNode
        });
    };
    ...
    _createClass(IntersectionObserver, [{
        ...
        get: function get() {
            ...
            return observerOptions.reduce(function (options, key) {
                if (IntersectionObserver_objectProto.hasOwnProperty.call(_this3.props, key)) {
                    var useQuery = key === 'root' && IntersectionObserver_objectProto.toString.call(_this3.props[key]) === '[object String]';
...
IntersectionObserver_IntersectionObserver.displayName = 'IntersectionObserver';
/* harmony default export */ var es_IntersectionObserver = (IntersectionObserver_IntersectionObserver);
 false ? void 0 : void 0;
// CONCATENATED MODULE: ../node_modules/@researchgate/react-intersection-observer/lib/es/index.js


// CONCATENATED MODULE: ./components/ViewableMonitor.js
var ViewableMonitor__extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };



function _objectWithoutProperties(obj, keys) { var target = {}; for (var i in obj) { if (keys.indexOf(i) >= 0) continue; if (!Object.prototype.hasOwnProperty.call(obj, i)) continue; target[i] = obj[i]; } return target; }

function ViewableMonitor__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function ViewableMonitor__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function ViewableMonitor__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }




var ViewableMonitor_ViewableMonitor = function (_Component) {
	ViewableMonitor__inherits(ViewableMonitor, _Component);

	function ViewableMonitor() {
		var _temp, _this, _ret;

		ViewableMonitor__classCallCheck(this, ViewableMonitor);

		for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
			args[_key] = arguments[_key];
		}

		return _ret = (_temp = (_this = ViewableMonitor__possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
			isIntersecting: false
		}, _this.handleChange = function (_ref) {
			var isIntersecting = _ref.isIntersecting;

			_this.setState({ isIntersecting: isIntersecting });
		}, _temp), ViewableMonitor__possibleConstructorReturn(_this, _ret);
	}

	ViewableMonitor.prototype.render = function render() {
		var isIntersectionObserverPresent = 'IntersectionObserver' in window;

		var _props = this.props,
		    children = _props.children,
		    rest = _objectWithoutProperties(_props, ['children']);

		var element = children[0](isIntersectionObserverPresent ? this.state.isIntersecting : true);

		if (isIntersectionObserverPresent) {
			return Object(preact_min["h"])(
				es_IntersectionObserver,
				ViewableMonitor__extends({}, rest, { onChange: this.handleChange }),
				element
			);
		}
		return Object(preact_min["h"])(
...
var news_tile_NewsTile = function (_Component) {
	...
	NewsTile.prototype.render = function render(props) {
		...
		return Object(preact_min["h"])(
			ViewableMonitor_ViewableMonitor,
			options,
			function (isViewable) {
				return Object(preact_min["h"])(
					Card_default.a,
					...
					Object(preact_min["h"])(
						'a',
						{ 'class': home_style_default.a.cardHeader, style: isViewable ? 'background-image:url(' + props.news.img + ')' : '' },
						Object(preact_min["h"])(
							'div',
...
var home_Home = function (_Component) {
	...
	Home.prototype.componentDidMount = function componentDidMount() {
		...
		caches.match('api/fetch/national').then(function (response) {
			if (response && response.ok) {
				response.json().then(function (data) {
					_this2.props.reducer.news.length === 0 && _this2.props.dispatch({
						type: NEWS_FETCHED,
						data: data
					});
				});
	...
	Home.prototype.render = function render(props) {
		...
		return Object(preact_min["h"])(
			...
			Object(preact_min["h"])(Snackbar_default.a, { ref: function ref(bar) {
					_this3.bar = bar;
					window.snackbar = bar;
				}
			})
